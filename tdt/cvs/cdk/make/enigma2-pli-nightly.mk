...
$(DEPDIR)/enigma2-pli-nightly.do_prepare:
	...
	echo "3) Sat,  8 Aug 2012 19:30 - E2 OpenPli a3b233a2545a5de7ed1b798137ee1da597856b9e"; \
	read -p "Select: "; \
	...
	[ "$$REPLY" == "3" ] && DIFF="3" && REVISION="a3b233a2545a5de7ed1b798137ee1da597856b9e" && REPO="git://openpli.git.sourceforge.net/gitroot/openpli/enigma2"; \
