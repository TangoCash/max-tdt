...
FFMPEG_CONFIGURE += --enable-decoder=mp3 --enable-decoder=mpeg1video --enable-decoder=mpeg2video --enable-decoder=pcm_s16le
FFMPEG_CONFIGURE += --enable-decoder=pcm_s16le_planar --enable-decoder=pgssub --enable-decoder=png --enable-decoder=srt
